...
const submitTransactionWithRetry = createRetryable(
  (...args: unknown[]) => submitTransaction(args[0] as object),
  3,
  1000
);
...
export function App(): JSX.Element {
  ...
  const handleAppError = (error: Error, errorInfo: ReactErrorInfo) => {
